...
| Assessment | assessment | definition/version API + staff builder + learner attempt core tested/merged; directed distribution is next | staff scope plus student-only attempt ownership, CSRF writes, idempotency, expiry and server scoring tested | exact published/question versions; transactional attempts/answers/results; no copied question payload state | staff responsive parity plus learner mobile attempt/result checkpoint green | PR #44 exact-head Backend + Frontend + E2E green; merged as 56d6d6edf661a44f8919efefcc8d60565da0a7b0 | TESTED |
