...
| Review/Adaptive | learning | evidence/mastery/review foundation + remediation loop tested/merged; lesson/video progress in review; goals/plans/interventions remain | student-only review/mastery/progress scope, CSRF mutations, retry-safe Assessment handoff, server scoring, answer-key secrecy and learner-safe Content resolver boundaries | normalized mastery evidence/skill progress/review-card/review-submission plus context-isolated lesson/video progress relations | responsive review/mastery/remediation plus Course progress mobile checkpoint in review | Lesson/video exact-head Database + Backend + Frontend + E2E required before merge | IN_PROGRESS |
