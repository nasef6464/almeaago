...
| Assessment | assessment | definition/version API + staff builder + learner attempts + directed assignments + result/review tested/merged; learning placements and public/barcode/live sessions remain | staff scope plus student-only attempt/result ownership, CSRF writes, idempotency, expiry, server scoring and review secrecy tested | exact published/question versions; transactional attempts/answers/results; no copied question payload state | staff responsive parity plus learner mobile attempt/result/review checkpoints green | PR #46 exact-head Backend + Frontend + E2E green; merged as 0fabf767557806d17012fb8456c3696698b97b0c | TESTED |
