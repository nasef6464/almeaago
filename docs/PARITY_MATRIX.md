...
| Review/Adaptive | learning | evidence/mastery/review foundation tested/merged; remediation attempt loop remains | student-only review/mastery scope, CSRF save mutations and retry-safe Assessment evidence handoff tested | normalized mastery evidence/skill progress/review-card relations; canonical Question version reuse | responsive review/mastery checkpoint green; dedicated remediation-session visuals remain | PR #49 exact-head Database + Backend + Frontend + E2E green; merged as 61e67ef145179832d57a1de19b8652d9d086c7e4 | TESTED |
