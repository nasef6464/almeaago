...
| Assessment | assessment | definition/version API pending; schema contract specified | scope model specified; application authorization pending | normalized definition/version/distribution/attempt/answer/result schema tested | pending | Database apply/rollback/re-apply + Backend CI green | IN_PROGRESS |
