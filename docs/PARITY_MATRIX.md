...
| Assessment | assessment | definition/version API tested/merged in PR #42; execution/distribution remains later | admin/teacher scope, CSRF, workflow, publication and optimistic revision tested | normalized definition/version/distribution/attempt/answer/result schema tested; API references exact question versions | pending | PR #42 exact-head Backend CI green; merged as 0348540c024c1fb0d1fb5e93fa230140304ca1ae | TESTED |
