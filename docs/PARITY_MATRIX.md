...
| Assessment | assessment | definition/version API + staff builder + learner attempts + directed assignments + result/review + learning placements tested/merged; public/barcode/live sessions remain | staff scope plus student-only attempt/result/placement ownership, CSRF writes, idempotency, expiry, server scoring and review secrecy tested | exact published/question versions; relational placements and transactional attempts/answers/results; no copied question/content payload state | staff responsive parity plus learner mobile attempt/result/review/placement checkpoints green | PR #47 exact-head Backend + Frontend + E2E green; merged as 3d45c6af4e5b03f5f2e136ae068f74c275f1cb93 | TESTED |
