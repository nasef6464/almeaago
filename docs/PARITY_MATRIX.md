...
| Review/Adaptive | learning | evidence/mastery/review foundation + due remediation/mastery-review answer loop tested/merged; goals/plans/interventions/lesson progress remain | student-only review/mastery scope, CSRF mutations, retry-safe Assessment handoff, server scoring, optimistic due-card state and answer-key secrecy tested | normalized mastery evidence/skill progress/review-card/review-submission relations; canonical Question version reuse | responsive review/mastery + mobile remediation checkpoint green | PR #50 exact-head Database + Backend + Frontend + E2E green; merged as e9895e78ecd21c956fbdc97be23c4c9a9e78cfe8 | TESTED |
