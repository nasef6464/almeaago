...
export type AssessmentAccessType='free'|'paid'|'private'|'course_only';
export type AssessmentPlacementAccessType='inherit'|'free'|'paid'|'package';
...
export interface AssessmentPlacement{id:string;assessmentId:string;assessmentVersion:number;slot:AssessmentPlacementSlot;accessType:AssessmentPlacementAccessType;pathId:string;subjectId:string;courseId:string;lessonId:string;topicId:string;isVisible:boolean;sortOrder:number;createdAt:string;updatedAt:string}
export interface AssessmentPlacementWrite{slot:AssessmentPlacementSlot;accessType:AssessmentPlacementAccessType;pathId:string;subjectId:string;courseId:string;lessonId:string;topicId:string;isVisible:boolean;sortOrder:number}
export interface AssessmentPlacementPage{items:AssessmentPlacement[];page:number;limit:number;hasMore:boolean}
export interface LearnerAssessmentPlacement{placementId:string;assessmentId:string;assessmentVersion:number;assessmentKind:'normal'|'mock';title:string;slot:AssessmentPlacementSlot;pathId:string;subjectId:string;courseId:string;lessonId:string;topicId:string;sortOrder:number;attemptCount:number;maxAttempts:number;accessType:AssessmentPlacementAccessType;baseAccessType:AssessmentAccessType;accessAllowed:boolean;accessReason:string;canStart:boolean}
