...
export interface LearnerCourse extends LearnerCourseSummary{modules:LearnerCourseModule[];access:{allowed:boolean;configured:boolean;reason:string;productId:string}}
