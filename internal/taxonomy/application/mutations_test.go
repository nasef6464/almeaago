...
func (r *mutationRepoStub) UpdatePath(context.Context, string, string, taxonomy.PathPatch) (taxonomy.Path, error) {
	return taxonomy.Path{}, nil
}
func (r *mutationRepoStub) CreateLevel(context.Context, string, taxonomy.LevelWrite) (taxonomy.Level, error) {
	return taxonomy.Level{}, nil
}
func (r *mutationRepoStub) UpdateLevel(context.Context, string, string, taxonomy.LevelPatch) (taxonomy.Level, error) {
	return taxonomy.Level{}, nil
}
func (r *mutationRepoStub) CreateSubject(context.Context, string, taxonomy.SubjectWrite) (taxonomy.Subject, error) {
	return taxonomy.Subject{}, nil
}
func (r *mutationRepoStub) UpdateSubject(context.Context, string, string, taxonomy.SubjectPatch) (taxonomy.Subject, error) {
	return taxonomy.Subject{}, nil
}
func (r *mutationRepoStub) CreateSkill(_ context.Context, _ string, w taxonomy.SkillWrite) (taxonomy.Skill, error) {
	r.lastSkill = w
	return taxonomy.Skill{}, nil
}
func (r *mutationRepoStub) UpdateSkill(context.Context, string, string, taxonomy.SkillPatch) (taxonomy.Skill, error) {
	return taxonomy.Skill{}, nil
}

func taxonomyActor(role identity.Role) identity.User {
...
func TestTaxonomyCodesNormalizeButRemainStableAfterCreate(t *testing.T) {
	...
	if repo.lastSkill.Code != "SKILL-A" {
		t.Fatalf("expected normalized code, got %q", repo.lastSkill.Code)
	}
}
