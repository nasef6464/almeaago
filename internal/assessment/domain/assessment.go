...
func ValidWorkflowStatus(v WorkflowStatus) bool {
	switch v { case WorkflowDraft, WorkflowPendingReview, WorkflowApproved, WorkflowRejected, WorkflowArchived: return true }
	return false
}
...
func ValidOwnerType(v OwnerType) bool { return v==OwnerPlatform || v==OwnerTeacher || v==OwnerSchool }

type Kind string
const ( KindNormal Kind = "normal"; KindMock Kind = "mock" )
type NormalMode string
const ( ModePractice NormalMode = "practice"; ModeExam NormalMode = "exam" )
